              ...
              <li>
                ...
                <ul style="width: 200px;">
                  ...
                  // $sub_categories = json_decode($row['data_subdets'],true);
                    $sub_categories = $this->db->get_where('sub_category', array('category' => $row['category_id']));
                  foreach($sub_categories->result() as $row1)
                  {
                    // if($this->crud_model->if_publishable_subcategory($row['sub_id'])){
                    //   $query = $this->db->get_where('sub_category', array('sub_category_id' => $row1['sub_id']));
                    //   foreach ($query->result() as $rowsss)
                    //   {
                    //     $rowsss->sub_category_name;
                    ...
                    //   }
                      ...
                      <li>
                        ...
                        <ul style="width: 200px;">
                          <?php
                         $subsub_categories = $this->db->get_where('subsubcat', array('subsubcat_id' => $row1->sub_category_id));
                          foreach($subsub_categories->result() as $row3)
                          {
                            // if($this->crud_model->if_publishable_subsubcategory($row['sub_id'])){
                              ?>
                              <li>
                                <a href="<?php echo base_url(); ?>home/category/<?php echo $row['category_id']; ?>/<?php echo $row1->sub_category_id; ?>/<?php echo $row3->sub_id; ?>">
                                  <?php echo $row3->subsubcat_name; ?>
                                </a>
                               <!--  <ul style="width: 200px;">
                                  <?php
                                  $brands=explode(';;;;;;',$row2->sub_id);
