            ...
            <div class="col-sm-8 col-sm-offset-2">
                ...
                ?>
                	<div class="row box_shape">
                        ...
                        <div class="col-md-12">
                            <div class="form-group">
                                <input class="form-control" name="company" type="text" placeholder="<?php echo translate('Business Name');?>" data-toggle="tooltip" title="<?php echo translate('Business Name');?>">
                            </div>
                        </div>
                        
                        <div class="col-md-12">
                            <div class="form-group">
                                <input class="form-control vendor_gst required" name="vendor_gst" type="text" placeholder="<?php echo translate('GST NUMBER');?>" data-toggle="tooltip" title="<?php echo translate('GST NUMBER');?>">
                            </div> 
                        </div>
                        
                        <div class="col-md-6">
                            <div class="form-group">
                                <input class="form-control vendor_phone required" name="vendor_phone" type="text" placeholder="<?php echo translate('PHONE NUMBER');?>" data-toggle="tooltip" title="<?php echo translate('PHONE NUMBER');?>">
                            </div> 
                        </div>
                        
                        <div class="col-md-6">
                            <div class="form-group">
                                <input class="form-control vendor_telephone" name="vendor_telephone" type="text" placeholder="<?php echo translate('Telephone Number');?>" data-toggle="tooltip" title="<?php echo translate('Telephone Number');?>">
                            </div> 
                        </div>
                        ...
                        <div class="col-md-12">
                            <div class="form-group">
                                <input class="form-control required" name="vendor_billing_address" type="text" placeholder="<?php echo translate('Billing  Address');?>" data-toggle="tooltip" title="<?php echo translate('Billing  Address');?>">
                            </div>
                        </div>
