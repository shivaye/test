...
<div class="thumbnail box-style-1 no-padding">
    ...
    <div class="media-link image_delay" data-src="<?php echo $this->crud_model->file_view('product',$product_id,'','','thumb','src','multi','one'); ?>" style="background-image:url('<?php echo img_loading(); ?>');background-size:cover;">
        ...
        <?php
            ...
            <?php 
                ...
                $tax= $this->db->get_where('product',array('product_id'=>$product_id))->row()->tax ;  
                $tax_type= $this->db->get_where('product',array('product_id'=>$product_id))->row()->tax_type;  
    ...
    <div class="caption text-center">
        ...
        <div class="price"> 
        <del><?php echo $this->crud_model->get_product_price_with_gst($product_id,1); ?></del>
        <ins><?php echo $this->crud_model->get_product_price_with_gst($product_id,2); ?></ins> 
          </div>
