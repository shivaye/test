...
<div class="row">
    ...
    <div class="col-md-3">
        ...
        <div class="details-wrap">   
        <p><b>If product delivery address of delhi and vendor also delhi (Product delivery time 3 - 5 days) and vendor other state (Product delivery time 5 - 7 days).</b></p>
            <div class="details-box orders">                
                <?php
