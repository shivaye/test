                        	...
                        	<a class="link" href="<?php echo $this->crud_model->product_link($rec['product_id']); ?>">
                                ...
                                <div class="price">
                                    <?php if($rec['discount'] > 0){ ?> 
                                        ...
                                        <del><?php echo get_include_price($rec['sale_price'],$rec['tax'],$rec['tax_type']); ?><?php //echo currency($rec['sale_price']); ?></del>
                                    <?php 
                                    }
                                    else{
                                    ?>
                                    <ins>
                                        <?php //echo currency($rec['sale_price']); ?>
                                         <?php echo get_include_price($rec['sale_price'],$rec['tax'],$rec['tax_type']); ?>
                                    </ins>
                                    <?php
                                    }
                                    ?>
