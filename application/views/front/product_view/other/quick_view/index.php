...
<?php  
	...
	$p_add_type = $this->db->get_where('product',array('product_id'=>$row['product_id']))->row()->add_type;
	$p_ex_fimg   = $this->db->get_where('product',array('product_id'=>$row['product_id']))->row()->front_img;
    ...
    <div class="row product-single" style="margin-top: 0px;">
        ...
        <div class="col-md-7">
            ...
            <div class="product-price">
                ...
                <ins><?php echo $this->crud_model->get_product_price_with_gst($row['product_id'],2); ?></ins> 
               <del><?php echo $this->crud_model->get_product_price_with_gst($row['product_id'],1); ?></del>
