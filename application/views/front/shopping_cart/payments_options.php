    ...
    <?php
        ...
        $cc_set = $this->db->get_where('business_settings',array('type'=>'ccav_set'))->row()->value;
...
<div class="row">
    ...
    <div class="cc-selector col-sm-3">
        <input id="ccavenue" type="radio" style="display:block;" checked name="payment_type" value="ccavenue"/>
        <label class="drinkcard-cc" style="margin-bottom:0px; width:100%; overflow:hidden; " for="ccavenue" onclick="radio_check('ccavenue')">
            <img src="<?php echo base_url(); ?>template/front/img/preview/payments/ccavenue.png" width="100%" height="100%" style=" text-align-last:center;" alt="<?php echo translate('ccavenue');?>" />
