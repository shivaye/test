      ...
      <div class="panel-body">
        <div class="tab-content">
          <div class="col-md-12" style="border-bottom: 1px solid #ebebeb;padding: 5px;">
            <h1 class="page-header text-overflow"><?php echo translate('Import Category');?> <a href="<?php echo base_url('admin/subsubcat'); ?>" class="btn btn-info btn-labeled fa fa-step-backward pull-right" 
             ><?php echo translate('back_to_subsubcategory_list');?>
           </a></h1>
         ...
         <div class="tab-pane fade active in" style="border:1px solid #ebebeb; border-radius:4px;">
          <div class="row" style="padding:75px 50px;">
            ...
            <div class="col-sm-6">
              ...
              <?php echo form_open_multipart('admin/subsubcategory_bulk_upload'); ?>            
        ...
        <div class="col-sm-6">
          <h4>1) First Step <a href="<?php echo base_url('template/subsubcategory_bulk_upload.csv'); ?>" class="btn btn-xs btn-success">Download</a> CSV File</h4>
