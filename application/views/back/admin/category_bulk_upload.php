      ...
      <div class="panel-body">
        <div class="tab-content">
          <div class="col-md-12" style="border-bottom: 1px solid #ebebeb;padding: 5px;">
            <h1 class="page-header text-overflow"><?php echo translate('Import Category');?> <a href="<?php echo base_url('admin/category'); ?>" class="btn btn-info btn-labeled fa fa-step-backward pull-right" 
             ><?php echo translate('back_to_category_list');?>
           </a></h1>
        ...
        <div class="col-sm-6">
          <h4>1) First Step <a href="<?php echo base_url('template/category.csv'); ?>" class="btn btn-xs btn-success">Download</a> CSV File</h4>
