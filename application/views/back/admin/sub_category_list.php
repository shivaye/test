    ...
    <table id="demo-table" class="table table-striped"  data-pagination="true" data-show-refresh="true" data-ignorecol="0,3" data-show-toggle="true" data-show-columns="false" data-search="true" >
        ...
        <?php
            ...
            foreach($all_sub_category as $row){
                $i++;
                $upload_url  = base_url('admin/product_bulk_upload')."/".$row['sub_category_id']."/".$row['category'];
        ?>
        <tr>
            <td><?php echo $i; ?></td>
...
<!--             <?php
            ...
            <td class="text-right">
                ...
                <!--<a style="margin-top: 5px;" href="<?php echo $upload_url; ?>" class="btn btn-primary btn-xs btn-labeled fa fa-plus-circle ">
                        <?php echo translate('Upload Bulk Product');?>
                </a>-->
            </td>
        </tr>
        <?php
