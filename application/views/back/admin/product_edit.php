                        ...
                        <div id="product_details" class="tab-pane fade active in">
                            ...
                            <div class="form-group btm_border" id="sub" >
                                ...
                                <div class="col-sm-6" id="sub_cat">
                                    <?php echo $this->crud_model->select_html('sub_category','sub_category','sub_category_name','edit','demo-chosen-select required',$row['sub_category'],'category',$row['category'],'get_subsub'); ?>
                                </div>
                            </div>
                             <div class="form-group btm_border" id="subsub" >
                                <label class="col-sm-4 control-label" for="demo-hor-3"><?php echo translate('sub-sub-category');?></label>
                                <div class="col-sm-6" id="sub_cat_sub">
                                    <?php echo $this->crud_model->select_html('subsubcat','subsubcat','subsubcat_name','edit','demo-chosen-select required',$row['subsubcat'],'subsubcat_id',$row['sub_sub_category_id'],'get_brnd'); ?>
                                </div>
                            </div>
                            <div class="form-group btm_border" id="brn" >
                                ...
                                <div class="col-sm-6" id="brand" >
                                    <?php 
                                        $brands=json_decode($this->crud_model->get_type_name_by_id('subsubcat',$row['sub_sub_category_id'],'brand'),true);
                                        if(count($brands)>0){
...
<script type="text/javascript">
    ...
    function get_cat(id,now){
        ...
        function get_subsub(id){
        $('#subsub').hide('slow');
        ajax_load(base_url+'admin/product/subsubcat_by_subcat/'+id,'sub_cat_sub','other');
        $('#subsub').show('slow');
    }
