        ...
        <div class="tab-base">
            <div class="panel" style="margin-bottom:0px !important;">
                <div class="panel-body">
                    <div class="tab-content">
                        <div class="col-md-12" style="border-bottom: 1px solid #ebebeb;padding: 5px;">
                            <h1 class="page-header text-overflow"><?php echo translate('Import Products Selected Category and Sub Category and Brand wise');?> <a href="<?php echo base_url('admin/product'); ?>" class="btn btn-info btn-labeled fa fa-step-backward pull-right" 
				...
				<div class="col-sm-6">
			             ...
			             <?php echo form_open_multipart('admin/product_bulk_upload'); ?>
				...
				<div class="col-sm-6">
					 <h4>1) First Step <a href="<?php echo base_url('template/upload_with_category.csv'); ?>" class="btn btn-xs btn-success">Download</a> CSV File</h4>
            ...
            <div class="panel">
                <div class="panel-body">
                    <div class="tab-content">
                        <div class="col-md-12" style="border-bottom: 1px solid #ebebeb;padding: 5px;">
                            <h1 class="page-header text-overflow"><?php echo translate('Import Products In All Category');?>
				...
				<div class="col-sm-6">
					 <h4>1) First Step <a href="<?php echo base_url('template/all_upload_product_csv.csv'); ?>" class="btn btn-xs btn-success">Download</a> CSV File</h4>
					 <h4>2) Second Step Fill Data in CSV Sheet</h4>
					 <h4>3) Last Step Select CSV File and Upload Then waiting after some time</h4>
					 <p>Show Message Successful Upload Products and Error Products</p>
				</div>
