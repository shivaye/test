        ...
        <div class="col-sm-12">
            <div class="panel-body">
                <table class="table table-striped" style="border-radius:3px;">
                    ...
                    <tr>
                        <th class="custom_td"><?php echo translate('GST Number');?></th>
                        <td class="custom_td"><?php echo $row['gst_number']?></td>
                    </tr>
                    <tr>
                        <th class="custom_td"><?php echo translate('Account Holder Name');?></th>
                        <td class="custom_td"><?php echo $row['account_holder_name']?></td>
                    </tr>
                     <tr>
                        <th class="custom_td"><?php echo translate('Account Number');?></th>
                        <td class="custom_td"><?php echo $row['account_number']?></td>
                    </tr>
                    <tr>
                        <th class="custom_td"><?php echo translate('IFSC Code');?></th>
                        <td class="custom_td"><?php echo $row['ifsc_code']?></td>
                    </tr>
