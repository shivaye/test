...
foreach($category_data as $row){
	...
	<div class="tab-pane fade active in" id="edit">
		...
		<div class="panel-body">
			...
			<div class="form-group">
				<label class="col-sm-4 control-label" for="demo-hor-1">
					<?php echo translate('slug_name');?>
				</label>
				<div class="col-sm-6">
					<input type="text" name="slug_name" id="demo-hor-1" 
					class="form-control required" placeholder="<?php echo translate('slug_name');?>" >
				</div>
			</div>
			<div class="form-group">
				<label class="col-sm-4 control-label" for="demo-hor-1">
					<?php echo translate('Gst Amount');?>
				</label>
				<div class="col-sm-6">
					<input type="number" name="gst_amount" id="demo-hor-1" 
					class="form-control required" value="<?php echo $row['gst_amount'];?>" placeholder="<?php echo translate('Gst Amount');?>" >
				</div>
			</div>
			<div class="form-group">
