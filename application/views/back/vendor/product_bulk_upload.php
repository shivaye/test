        ...
        <div class="tab-base">
            <div class="panel" style="margin-bottom:0px !important;">
                <div class="panel-body">
                    <div class="tab-content">
                        <div class="col-md-12" style="border-bottom: 1px solid #ebebeb;padding: 5px;">
                            <h1 class="page-header text-overflow"><?php echo translate('Import Products Selected Category and Sub Category and Brand wise');?> <a href="<?php echo base_url('vendor/product'); ?>" class="btn btn-info btn-labeled fa fa-step-backward pull-right" 
				...
				<div class="col-sm-6">
			             ...
			             <?php echo form_open_multipart('vendor/product_bulk_upload'); ?>
