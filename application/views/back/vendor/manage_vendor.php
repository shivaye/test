                ...
                <div class="tab-content">
                    <div class="tab-pane fade active in" id="" style="border:1px solid #ebebeb; border-radius:4px;">
                        ...
                        ?>
                            <div class="panel-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-6">
                                        <input type="email" name="email" value="<?php echo $row['email']; ?>" id="demo-hor-2" disabled class="form-control required">
                                    </div>
                                </div>
                                <div class="form-group">
                                 ...
                                 <div class="form-group">
                                    <label class="col-sm-3 control-label" for="demo-hor-3">
										<?php echo translate('Telephone Number');?>
                                        	</label>
                                    <div class="col-sm-6">
                                        <input type="text" name="vendor_telephone" value="<?php echo $row['telephone_number']; ?>" class="form-control">
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label class="col-sm-3 control-label" for="demo-hor-3">
										<?php echo translate('GST Number');?>
                                        	</label>
                                    <div class="col-sm-6">
                                        <input type="text" name="vendor_gst" value="<?php echo $row['gst_number']; ?>" class="form-control">
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label class="col-sm-3 control-label" for="demo-hor-4">
										<?php echo translate('Billing Address');?>
                                        	</label>
                                    <div class="col-sm-6">
                                        <input type="text" name="vendor_billing_address" value="<?php echo $row['billing_address']; ?>" class="form-control address" onblur="set_cart_map('iio');">
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label class="col-sm-3 control-label" for="demo-hor-4">
                        ...
                        <div class="panel-heading">
                        	...
                        	<?php
                                echo form_open(base_url() . 'vendor/manage_vendor/bank_update/', array(
                                    'class' => 'form-horizontal',
                                    'method' => 'post'
                                ));
                            ?>
                        	<div class="panel panel-success">
                        	 <div class="panel-heading">
                            <h3 class="panel-title"><?php echo translate('Bank Details');?></h3>
                            </div>
                            <div class="panel-body">
                            
                            <div class="form-group">
                                        <label class="col-sm-3 control-label" for="demo-hor-5">
                                        	<?php echo translate("Account Holder's Name*");?>
                                            	</label>
                                        <div class="col-sm-6">
                                            <input type="text" name="ac_holder_name" value="<?php echo $row['account_holder_name']; ?>" class="form-control required" placeholder="Account Holder Name">
                                        </div>
                                    </div>
                                    
                                    <div class="form-group">
                                        <label class="col-sm-3 control-label" for="demo-hor-7">
                                        	<?php echo translate('Bank Account Number*');?>
                                            	</label>
                                        <div class="col-sm-6">
                                            <input type="number" name="account_number" value="<?php echo $row['account_number']; ?>" class="form-control required" placeholder="Bank Account Number">
                                        </div>
                                        <div id="pass_note">
                                        </div>
                                    </div>
                                     ...
                                     <div class="form-group">
                                        <label class="col-sm-3 control-label" for="demo-hor-6">
                                        	<?php echo translate('IFSC Code*');?>
                                            	</label>
                                        <div class="col-sm-6">
                                            <input type="text" name="ifsc_code" value="<?php echo $row['ifsc_code']; ?>" class="form-control required" placeholder="IFSC Code">
                                        </div>
                                    </div>
                            
                            </div>
                             <div class="panel-footer text-right">
                                    <input type="submit"  class="btn btn-info enterer" value="<?php echo translate('update_account_details');?>" name="update_bank_details">
                                </div>
                        	</div>
                        	</form>
