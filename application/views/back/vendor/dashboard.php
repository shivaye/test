                    ...
                    <div class="panel panel-bordered panel-grad2" style="height:260px !important;">
                        <div class="panel-heading">
                            <h3 class="panel-title">
								<?php echo translate('Product Parking Charge');?>
                            </h3>
                        </div>
                        <div class="panel-body">
                            <div class="text-center">
                                <h3>Products Price Rs.1 To Rs.500/-  (Products Parking Charge Rs.3). 501-1500(Products Parking Charge Rs.5). 1501-Above(Products Parking Charge Rs.7)   
                                     </h3>
                            </div>
                        </div>
                    </div> 
