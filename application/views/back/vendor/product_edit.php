                            ...
                            <div class="form-group btm_border" id="sub" >
                             ...
                             <div class="form-group btm_border" id="subsub" >
                                ...
                                <div class="col-sm-6" id="sub_cat_sub">
                                    <?php echo $this->crud_model->select_html('subsubcat','sub','subsubcat_name','edit','demo-chosen-select required',$row['sub_category'],'subsubcat_id',$row['sub_sub_category_id'],'get_brnd'); ?>
                                </div>
                            </div>
...
<script type="text/javascript">
    ...
    function get_cat(id){
        ...
        $('#subsub').hide('slow');
        ajax_load(base_url+'vendor/product/subsubcat_by_subcat/'+id,'sub_cat_sub','other');
        $('#subsub').show('slow');
    }
