 ...
 */
	...
	if ( ! function_exists('translate'))
	{
	   ...
	   function send_sms($a,$b){
       $ch        = curl_init(); 
	$mobile       = $a;
	$message      = urlencode($b);
    $url = "https://sms.contourdigitalmedia.com/api/v4/?api_key=Ae308ee6283fd22f117a0545434d6b03c&method=sms&message=$message&to=$mobile&sender=AIPLDL";
